...
namespace Invector
{
    public class vFootStep : vFootStepBase
    {
        ...
        [SerializeField] protected bool _spawnParticle = false;
        [vHelpBox("Enable or disable spawn step mark when foot step is triggered")]
        [SerializeField] protected bool _spawnStepMark = false;
        ...
        [SerializeField] protected bool _useTriggerEnter = false;
